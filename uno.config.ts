...
export default defineConfig({
  shortcuts: {
    ...
    'typography': 'prose prose-neutral dark:prose-invert prose-h1:font-serif prose-h2:font-serif prose-h3:font-serif prose-blockquote:font-mono prose-a:link font-sans',
    'divide': 'divide-y not-dark:divide-neutral-200 dark:divide-neutral-900',
    'link': 'underline decoration-offset-3',
  },
  presets: [
    presetWind4({
      dark: 'media',
    ...
    presetWebFonts({
      ...
      fonts: {
        ...
        serif: ['Noto Serif JP', 'Noto Serif KR', 'Noto Serif TC'],
